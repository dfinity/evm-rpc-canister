...
- Add cycles cost endpoints ([#509](https://github.com/dfinity/evm-rpc-canister/pull/509))
- Add retry strategy to client ([#512](https://github.com/dfinity/evm-rpc-canister/pull/512))

### Changed

- Use `sol!` macro in `eth_call` example ([#515](https://github.com/dfinity/evm-rpc-canister/pull/515))
- Hide imports in Rust doc ([#511](https://github.com/dfinity/evm-rpc-canister/pull/511))
- Expand `evm_rpc_client` README ([#510](https://github.com/dfinity/evm-rpc-canister/pull/510))

### Fixed

- Setup wallet canister for integration tests ([#513](https://github.com/dfinity/evm-rpc-canister/pull/513))

[0.1.1]: https://github.com/dfinity/evm-rpc-canister/compare/0.1.0..0.1.1
